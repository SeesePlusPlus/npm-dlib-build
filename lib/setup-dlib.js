...
module.exports = function() {
  ...
  const fpicSupportInsert = 'add_definitions("-fPIC")\nset(CMAKE_POSITION_INDEPENDENT_CODE true)'
  return getRunBuildCmd().then(runBuildCmd =>
    exec(getMkDirCmd('dlib'), { cwd: rootDir })
      ...
      .then(() => spawn('git', ['checkout', 'tags/v19.17', '-b', 'v19.17'], { cwd: dlibSrc }))
      .then(() => spawn('sed', ['-i', `67i${fpicSupportInsert}`, 'dlib/CMakeLists.txt']))
